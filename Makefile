...
init:
	${CMAKE_BINARY} -DMOD_ID=${MOD_ID} -DMOD_NAME="Terrain Variations" -DDESCRIPTION="${MOD_DESCRIPTION}" -DDEVELOPER="nmattela" -DDEVELOPER_URL="https://github.com/nmattela/sapiens_terrain_variations" -DPREVIEW_FILE="preview.png" -DMOD_MAJOR_VERSION=1 -DMOD_MINOR_VERSION=2 -DMOD_PATCH_VERSION=1 . -B build
	cmake --build build/
